 ...
 * /comments/{petId}:
 *   get:
 *     summary: Obtener comentarios de una mascota
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Lista de comentarios de la mascota
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 *                   type: string
 *       404:
 *         description: Mascota no encontrada o sin comentarios
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 * /comments/{petId}:
 *   post:
 *     summary: Crear un comentario para una mascota
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               content:
 *                 type: string
 *                 example: "¡Qué mascota tan adorable!"
 *     responses:
 *       201:
...
/**
 * @swagger
 * /comments/{petId}/{commentId}:
 *   put:
 *     summary: Actualizar un comentario de una mascota
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 * /comments/{petId}/{commentId}:
 *   delete:
 *     summary: Eliminar un comentario de una mascota
 *     tags: [Comments]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *                   type: string
 *       403:
 *         description: No tienes permiso para borrar este comentario
 *         content:
 *           application/json:
 *             schema:
 *               type: object
